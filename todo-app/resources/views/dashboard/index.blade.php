...
<div class="wrapper bg-white mt-5">
    ...
    <div class="d-flex align-items-start justify-content-between">
        <div class="d-flex flex-column">
            <div class="h5">My job's</div>
            <p class="text-muted text-justify">
            Here's a list of jobs you have to do
            </p>
            <br>
            <span>
                <a href="{{route('todo.create')}}" class="text-success">Create Job</a> | <a href="{{route('todo.complated')}}">Completed</a>
            </span>
        </div>
